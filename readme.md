...
```bash
git clone https://github.com/davidsonic/lids-alum-demo.git
cd lids-alum-demo
vagrant up
vagrant ssh
...
The demo site will now be accessible at [http://localhost:8000/](http://localhost:8000/) and the admin
...
All content in the demo is public domain. All images are from either Wikimedia Commons or other copyright-free sources.
